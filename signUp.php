...
<!-- Creates the form where the users can input data -->
  <form method = "post", action = 'signUp.php' style = "  border-radius: 5px solid;padding: 25px 100px ">
    ...
    <input type="text" placeholder="Enter your full name" name = "fullname" class="fullname" required>
    ...
    <input type="password" placeholder="Enter Password again" name="pass2" class="pass2" required>
